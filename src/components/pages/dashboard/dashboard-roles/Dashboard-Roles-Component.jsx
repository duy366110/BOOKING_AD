...
const DashboardRolesComponent = (props) => {
    ...
    const getRoles = async () => {
        ...
        if(status) {
            ...
            httpMethod({
                url: `${configEnv.URL}/api/admin/role/${pagination.role.elementOfPage}/${(pagination.role.elementOfPage * pagination.role.currentPage)}`,
                method: 'GET',
                author: '',
                payload: null
            }, (infor) => {
    ...
    const deleteRoleHandler = async (event) => {
        ...
        if(window.confirm('Are you sure delete role!')) {
            httpMethod({
                url: `${configEnv.URL}/api/admin/role`,
                method: 'DELETE',
                author: '',
...
export const loader = (request, params) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let res = await fetch(`${configEnv.URL}/api/admin/role/amount`, {
                method: 'GET',
                headers: {
