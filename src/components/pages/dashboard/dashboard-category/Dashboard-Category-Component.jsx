...
const HeadTable = ['STT', 'Title', "Image", "Hotels", 'Action'];
...
const DashboardCategoryComponent = (props) => {
    ...
    const loadCategoryHandler = async() => {
        httpMethod({
            url: `${configEnv.URL}/api/admin/category/${pagination.category.elementOfPage}/${(pagination.category.elementOfPage * pagination.category.currentPage)}`,
            method: 'GET',
            author: '',
            payload: null,
            customForm: false
...
export const loader = () => {
    return new Promise( async(resolve, reject) => {
        try {
            ...
            let res = await fetch(`${configEnv.URL}/api/admin/category/amount`, {
                method: 'GET',
                headers: {
