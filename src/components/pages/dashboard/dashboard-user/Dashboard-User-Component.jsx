...
const DashboardUserComponent = (props) => {
    ...
    const getUsers = async () => {
        ...
        if(status) {
            ...
            httpMethod({
                url: `${configEnv.URL}/api/admin/user/${pagination.user.elementOfPage}/${(pagination.user.elementOfPage * pagination.user.currentPage)}`,
                method: 'GET',
                author: '',
                payload: null
            }, (infor) => {
...
export const loader = () => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            let res = await fetch(`${configEnv.URL}/api/admin/user/amount`, {
                method: 'GET',
                headers: {
